...
- **[rlm-orchestrator.md](/prompts/rlm-orchestrator/)** - Root LLM prompt for task decomposition
- **[rlm-analyst.md](/prompts/rlm-analyst/)** - Sub-LLM prompt for chunk analysis
- **[rlm-synthesizer.md](/prompts/rlm-synthesizer/)** - Root LLM prompt for result aggregation
...
- **[Features Guide](/getting-started/features/)** - Learn about feature flags and optimization
- **[CLI Reference](/getting-started/cli-reference/)** - Complete command documentation
- **[Architecture](/architecture/architecture/)** - Understand internal design
- **[Plugin Integration](/reference/plugin-integration/)** - Integrate with Claude Code and other tools
