...
|----------|---------|-------------------|
| [rlm-orchestrator.md](/prompts/rlm-orchestrator/) | Coordinates search, dispatch, and synthesis | sonnet |
| [rlm-analyst.md](/prompts/rlm-analyst/) | Analyzes individual chunks | haiku |
| [rlm-synthesizer.md](/prompts/rlm-synthesizer/) | Aggregates analyst findings | sonnet |
...
- [RLM-Inspired Design](/architecture/rlm-inspired-design/) - Architectural philosophy
- [CLI Reference](/getting-started/cli-reference/) - Complete command documentation
- [Architecture](/architecture/architecture/) - Internal implementation details
