...
**Summary:** In v1.1.2, the default chunk size was further revised to 3,000 characters (from
240,000) and the maximum to 50,000. The original decision to use 2,000 bytes was superseded by
this subsequent tuning. The CLI `--chunk-size` override remains available.
