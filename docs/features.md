...
**Dependencies:**
- `usearch` crate v2.23.x–v2.24.x from crates.io (pinned `<2.25`)
- Requires C++ compiler (C++17 or later)

> **Note:** Version 2.25.0+ is excluded pending validation. See [Troubleshooting](troubleshooting.md#usearch-version-issues) for details.
